...
awful.screen.connect_for_each_screen(function(s)
    ...
    --Create the wibox
    s.mywibox = awful.wibar({ position = "top", screen = s, height = 50, shape=gears.shape.octogon})
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey },            "b",     function () awful.util.spawn("google-chrome") end,
     ...
     -- VsCodium
    awful.key({ modkey },            "v",     function () awful.util.spawn("codium") end,
    ...
    awful.key( {}, "#122", function() awful.util.spawn("pactl set-sink-volume @DEFAULT_SINK@ -10%","false") end  ),
    awful.key( {}, "#123", function() awful.util.spawn("pactl set-sink-volume @DEFAULT_SINK@ +10%","false") end  )	      
)
